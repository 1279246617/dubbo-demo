...
public interface IOrderAdditionalSfDao {
	...
	public int saveBatchOrderAdditionalSfWithOrderId(List<OrderAdditionalSf> additionalSfList, Long orderId);

	public List<OrderAdditionalSf> findOrderAdditionalSf(OrderAdditionalSf Order,
