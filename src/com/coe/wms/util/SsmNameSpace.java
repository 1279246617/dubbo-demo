...
/**
 * om.google.code.ssm.api.ReadThroughSingleCache 缓存命名空间
 * 
 * @author Administrator
 * 
 */
public class SsmNameSpace {
	/**
	 * 用户表
	 */
	 ...
	 * 转运订单大包状态表
	 */
	public static final String TRANSPORT_ORDER_PACKAGE_STATUS = "TRANSPORT_ORDER_PACKAGE_STATUS";
	/**
	 * 转运订单头程运单状态表
	 */
	public static final String TRANSPORT_FIRST_WAYBILL_STATUS = "TRANSPORT_FIRST_WAYBILL_STATUS";
	/**
	 * 币种表
	 */
