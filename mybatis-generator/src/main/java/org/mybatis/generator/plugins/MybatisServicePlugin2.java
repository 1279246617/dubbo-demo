 ...
 * 生成service类
 */
public class MybatisServicePlugin2 extends PluginAdapter {
...
//		method= getPagerEntitys(topLevelClass, introspectedTable, tableName);
//		method.removeAllBodyLines();
//		interface1.addMethod(method);
...
//		method.addBodyLine("Pager<"+tableName+"> pager = new Pager<"+tableName+">();");
	...
	private Method getEntitys(IntrospectedTable introspectedTable,
		...
		// -1 表示获取全部
		method.addBodyLine("criteria.setLimit(-1);");
		method.addBodyLine("setCriteria(cri, params);");
		StringBuilder sb = new StringBuilder();
		sb.append("return this.");
		sb.append(getDaoShort());
		if (introspectedTable.hasBLOBColumns()) {
			sb.append("selectByConditionWithoutBLOBsList");
		} else {
			sb.append("selectByConditionList");
		}
		sb.append("(");
		sb.append("criteria");
		sb.append(");");
...
//			 modify by yepeng 20160821 - update updateTime - 兼容 mysql datatime
...
//			 }
		...
		sb.append("if(this.");
		sb.append(getDaoShort());
		// modify by yepeng 20160822 - 注释 service updateByPrimaryKeySelectiveWithoutBLOBs
//		if (introspectedTable.hasBLOBColumns()) {
...
//		}
	...
	private Method deleteEntity(IntrospectedTable introspectedTable,
		...
		sb.append("return this.");
		sb.append(getDaoShort());
		// modify by yepeng 20160822 - 注释 service deleteByPrimaryKeyWithoutBLOBs
//		if (introspectedTable.hasBLOBColumns()){
...
//		}
	...
	private Method addEntity(TopLevelClass topLevelClass,IntrospectedTable introspectedTable,
		...
		List<IntrospectedColumn> introspectedColumnsList=introspectedTable.getAllColumns();
		 for (IntrospectedColumn introspectedColumn : introspectedColumnsList) {
			// modify by yepeng 20160821 - add createTime - 兼容 mysql datatime
//		     if(introspectedColumn.isJDBCDateColumn()||introspectedColumn.isJDBCTimeColumn()){
...
//		topLevelClass.addMethod(getPagerEntitys(topLevelClass, introspectedTable, tableName));
