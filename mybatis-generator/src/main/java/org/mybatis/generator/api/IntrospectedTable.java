...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByExampleStatementId("selectByConditionList"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("selectByConditionWithBLOBsList"); //$NON-NLS-1$
        ...
        setExampleWhereClauseId("Condition_Where_Clause"); //$NON-NLS-1$
        setBaseColumnListId("Base_Column_List"); //$NON-NLS-1$
        setBlobColumnListId("Blob_Column_List"); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId("Update_By_Condition_Where_Clause"); //$NON-NLS-1$
    }
