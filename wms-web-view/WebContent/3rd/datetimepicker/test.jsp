...
<title>首页</title>
    ...
    <script type="text/javascript" src="${ctx}/3rd/mm/mmui.js"  ></script>
	...
	<link href="${ctx}/3rd/datetimepicker2/css/bootstrap-datetimepicker.css" rel="stylesheet">
	<script src="${ctx}/3rd/datetimepicker2/js/bootstrap-datetimepicker.js"></script>
	<script src="${ctx}/3rd/datetimepicker2/js/locales/bootstrap-datetimepicker.zh-CN.js"></script>
	
	<link href="${ctx}/3rd/calendar/lhgcalendar.css" rel="stylesheet">
	<script src="${ctx}/3rd/calendar/lhgcalendar.js"></script>
</head>
<body>
