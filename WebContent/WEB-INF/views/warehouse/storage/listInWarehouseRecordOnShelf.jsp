...
<body>
	  <div class="toolbar1">
           <form action="${baseUrl}/warehouse/storage/getInWarehouseRecordOnShelfData.do" id="searchform" name="searchform" method="post">
...
<!--                		</span> -->
               		...
               		<span class="pull-left" style="width:200px;">
               			至	
               			<input type="text"   style="width:120px;" name="receivedTimeEnd"  id="receivedTimeEnd"  title="终止创建时间">
               		</span>
