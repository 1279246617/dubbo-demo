...
<body>
	<form id="batchimport" enctype="multipart/form-data" action="${baseUrl}/warehouse/importorder/executeImportOutWarehouseOrder.do" method="post">
		<table style="text-align: left;margin-top: 5px;margin-left: 5px;" >
				...
				<tr style="height: 50px;">
					...
					<th style="width:150px;">
						<a class="btn btn-primary  " onclick="submit()" title="确认上传出库订单,但不代表成功上传">
			           		 <i class="icon-check"></i>确认上传
			       	 	</a>
					</th>
					<th>
						<a class="btn  btn-success " onclick='downloadTemplate()' title="下载出库订单模版模版">
	...
	<script type="text/javascript">
		...
		function downloadTemplate(){
			var url = baseUrl + '/warehouse/importorder/downloadTemplate.do?templateId=2';
   			window.open(url);
		}
	 </script>
</html>