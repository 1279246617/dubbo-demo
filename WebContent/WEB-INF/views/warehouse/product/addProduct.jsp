...
<body>
	<div id="step1" style="margin-top: 3mm; width: 100%;" class="pull-left">
		...
		<div class="pull-left" style="width: 200px;">
			产品类型：<input type="text" name="productTypeName" id="productTypeName"
				style="width: 100px;">
		</div>
	</div>
	...
	<div id="step2" style="margin-top: 6mm; width: 100%;" class="pull-left">
		<div class="pull-left" style="width: 200px;">
			所属客户：<input type="text" name="userIdOfCustomer" id="userIdOfCustomer"
				style="width: 100px;">
		</div>
		<div class="pull-left" style="width: 200px;">
			是否需要生产批次 （Y/N）：<input type="text" name="isNeedBatchNo"
				id="isNeedBatchNo" style="width: 100px;">
		</div>
	</div>
	...
	<div id="step3" style="margin-top: 6mm; width: 100%;" class="pull-left">
		...
		<div class="pull-left" style="width: 200px;">
			仓库sku：<input type="text" name="warehouseSku" id="warehouseSku"
				style="width: 100px;">
		</div>
	</div>
	...
	<div id="step5" style="margin-top: 6mm; width: 100%;" class="pull-left">
		...
		<div class="pull-left" style="width: 200px;">
			报关重量（KG）：<input type="text" name="customsWeight" id="customsWeight"
				style="width: 100px;">
		</div>
	</div>
	...
	<div id="step6" style="margin-top: 6mm; width: 100%;" class="pull-left">
		<div class="pull-left" style="width: 200px;">
			价值币种：<input type="text" name="currency" id="currency"
				style="width: 100px;">
		</div>
		<div class="pull-left" style="width: 200px;">
			报关价值（元）：<input type="text" name="customsValue" id="customsValue"
				style="width: 100px;">
		</div>
	</div>
	...
	<div id="step7" style="margin-top: 6mm; width: 100%;" class="pull-left">
		<div class="pull-left" style="width: 200px;">
			行邮税号（ETK B2C渠道专用报关字段）：<input type="text" name="taxCode" id="taxCode"
				style="width: 100px;">
		</div>
		<div class="pull-left" style="width: 200px;">
			原产地：<input type="text" name="origin" id="origin"
				style="width: 100px;">
		</div>
	</div>
