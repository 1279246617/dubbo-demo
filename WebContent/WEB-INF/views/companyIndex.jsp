	    	...
	    	<div id="accordion1" class="  well main-menu"  > 
		        ...
		        <div title="仓库管理" class=" nav-collapse sidebar-nav">
		              <ul class="nav nav-tabs nav-stacked ">	
		              		...
		              		<li><a href="#${baseUrl}/warehouse/storage/listOutWarehousePackage.do" tab_id="findOutWarehousePackage"><i class="icon-zoom-out"></i><span class="hidden-tablet">建包发货记录</span></a></li>
