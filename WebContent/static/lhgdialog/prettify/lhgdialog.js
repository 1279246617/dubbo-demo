...
lhgdialog.fn = lhgdialog.prototype =
{
    ...
    {
        $(".ui_buttons [type='button']").each(function(){
            if(name==$(this).val())
                $(this).remove();
        });
    },
	...
	{
		var that = this, DOM = that.DOM,maxWidth, maxHeight, scaleWidth, scaleHeight,
			wrap = DOM.wrap[0],
		...
		maxHeight = _$top.height() - wrap.offsetHeight + main[0].offsetHeight;
